...
#Rebased prices: growth of 100 invested
...
# %% [markdown]
#Return distributions: fat tails
...
# %% [markdown]
# Rolling volatility: the risk lens
...
# %% [markdown]
# Correlation of RETURNS (never prices: trending prices fake ~0.9)
